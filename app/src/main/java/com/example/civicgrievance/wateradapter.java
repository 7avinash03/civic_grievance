...
public class wateradapter extends FirebaseRecyclerAdapter<model,wateradapter.myviewholder> {
    /**
     ...
     * @param options
     */
    public wateradapter(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("Filter").child("WatertapProblems").child(getRef(holder.getAdapterPosition()).getKey()).removeValue();
