...
public class roadadapter extends FirebaseRecyclerAdapter<model,roadadapter.myviewholder> {
    /**
     ...
     * @param options
     */
    public roadadapter(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("Filter").child("RoadProblems").child(getRef(holder.getAdapterPosition()).getKey()).removeValue();
