...
public class otheradapter extends FirebaseRecyclerAdapter<model,otheradapter.myviewholder> {
    /**
     ...
     * @param options
     */
    public otheradapter(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("Filter").child("otherProblems").child(getRef(holder.getAdapterPosition()).getKey()).removeValue();
