...
public class streetadapter extends FirebaseRecyclerAdapter<model,streetadapter.myviewholder> {
    /**
     ...
     * @param options
     */
    public streetadapter(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
    }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("Filter").child("StreetlightProblems").child(getRef(holder.getAdapterPosition()).getKey()).removeValue();
